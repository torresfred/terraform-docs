...
1. Reporting an issue or making a feature request [here](https://github.com/torresfred/terraform-docs/issues).
...
1. Fork and *git clone* [terraform-docs](https://github.com/torresfred/terraform-docs).
2. Create a new *git branch* from the master branch where you develop your changes.
3. Create a [Pull Request](https://help.github.com/articles/about-pull-requests/) for your contribution by following the instructions in the pull request template [here](https://github.com/torresfred/terraform-docs/pull).
...
1. **Tests**: Code changes need to be tested with code and tests being located in the same folder (see packages [doc](https://github.com/torresfred/terraform-docs/tree/master/doc/) and [print](https://github.com/torresfred/terraform-docs/tree/master/print/) for examples). Make sure that your tests pass using `make test`.

2. **Documentation**: Pull requests need to update the [documentation](https://github.com/torresfred/terraform-docs/tree/master/README.md) together with the code change.
